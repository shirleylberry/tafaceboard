...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Capability.level_note'
        db.add_column(u'tutorboard_capability', 'level_note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Capability.notes'
        db.add_column(u'tutorboard_capability', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Tutor.highestLevelManual'
        db.add_column(u'tutorboard_tutor', 'highestLevelManual',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Tutor.availability_note'
        db.add_column(u'tutorboard_tutor', 'availability_note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Tutor.availability_vacation'
        db.add_column(u'tutorboard_tutor', 'availability_vacation',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Capability.level_note'
        db.delete_column(u'tutorboard_capability', 'level_note')

        # Deleting field 'Capability.notes'
        db.delete_column(u'tutorboard_capability', 'notes')

        # Deleting field 'Tutor.highestLevelManual'
        db.delete_column(u'tutorboard_tutor', 'highestLevelManual')

        # Deleting field 'Tutor.availability_note'
        db.delete_column(u'tutorboard_tutor', 'availability_note')

        # Deleting field 'Tutor.availability_vacation'
        db.delete_column(u'tutorboard_tutor', 'availability_vacation')
