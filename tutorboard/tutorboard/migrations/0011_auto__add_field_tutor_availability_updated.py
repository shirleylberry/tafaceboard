...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutor.availability_updated'
        db.add_column(u'tutorboard_tutor', 'availability_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutor.availability_updated'
        db.delete_column(u'tutorboard_tutor', 'availability_updated')
