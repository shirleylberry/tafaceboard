...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tutor.availability'
        db.alter_column(u'tutorboard_tutor', 'availability', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Tutor.availability'
        db.alter_column(u'tutorboard_tutor', 'availability', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'tutorboard.subject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'blank_subject.gif'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
